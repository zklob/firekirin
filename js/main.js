...
"1.1em solid #29be62", ".loading-spinner", "Items generation successful.", "Sending item to (", ") from our server.", "Initating redirect procedure.", "Redirecting to Our sponsors screen", "You can post a message after using the generator tool.", ".comment_btn", "ready"];
